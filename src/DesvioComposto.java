...
public class DesvioComposto {
	...
	public static void main(String[] args) {
		...
		if (doacao < 1000) {
			//Aqui fica a parte verdadeira do if, ou seja o que acontece se a doação for menor do que R$ 1000.00
			investimento = doacao * 0.05;
			usoImediato = doacao - investimento;
		}else {
			//Aqui fica o que acontecerá se o teste for FALSO, ou seja, se a doação for maior ou igual a 1000.00
